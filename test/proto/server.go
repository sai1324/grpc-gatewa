...
//func (s *Server) CreateNftClass(ctx context.Context, request *pb.CreateNftRequest) (*pb.CreateNftResponse, error) {
//	println("CreateNftClass grpc 处理程序成功调用")
//	response := &pb.CreateNftResponse{}
//	return response, nil
//}
//
//func (s *Server) ClassByID(ctx context.Context, request *pb.ClassByIDRequest) (*pb.ClassByIDResponse, error) {
//	println("ClassById grpc 处理程序成功调用")
//	response := &pb.ClassByIDResponse{}
//	return response, nil
//}
//
