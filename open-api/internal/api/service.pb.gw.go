...
func RegisterWenchangchainHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WenchangchainClient) error {
	...
	mux.Handle("POST", pattern_Wenchangchain_CreateNftClass_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainservice.Wenchangchain/CreateNftClass", runtime.WithHTTPPathPattern("/nft/classes"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	//	var err error
	//	var annotatedContext context.Context
	//	annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/chainservice.Wenchangchain/ClassByID", runtime.WithHTTPPathPattern("/nft/classes/{id}"))
	//	if err != nil {
	//		runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	//		return
	//	}
